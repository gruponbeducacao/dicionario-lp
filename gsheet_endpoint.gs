 ...
 *    SHEET_ID = <ID da planilha "Recebimento de Leads - 1">.
 ...
 * 6. Autorizar os escopos (Avançado → Acessar → Permitir).
 * 7. Copiar a URL /exec e colar em GSHEET_ENDPOINT no index.html.
 *
...
// SHEET_ID fica em Script Properties (Configurações do projeto → Propriedades
// do script) pra não expor o ID da planilha neste repositório público.
...
function doPost(e) {
  try {
    ...
    try {
      var ss2 = SpreadsheetApp.openById(getSheetId_());
